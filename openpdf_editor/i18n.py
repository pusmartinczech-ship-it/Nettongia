...
BASE = {
    ...
    "ocr_unavailable": "The bundled offline OCR language data is unavailable. Reinstall the complete OpenPDF Editor package.",
    ...
    "recovery_question": "OpenPDF Editor found automatically saved unsaved work for {name}. Restore it?",
    "restore": "Restore",
    ...
    "about_title": "About OpenPDF Editor",
...
_ROWS.update({
    ...
    "recovery_question": ("OpenPDF Editor found automatically saved unsaved work for {name}. Restore it?", "OpenPDF Editor 找到了为 {name} 自动保存的未保存工作。是否恢复？", "OpenPDF Editor को {name} के लिए स्वतः सहेजा गया काम मिला। क्या इसे पुनर्प्राप्त करें?", "OpenPDF Editor encontró trabajo no guardado automáticamente para {name}. ¿Desea recuperarlo?", "OpenPDF Editor a trouvé un travail non enregistré sauvegardé automatiquement pour {name}. Le restaurer ?", "عثر OpenPDF Editor على عمل غير محفوظ تم حفظه تلقائيًا للملف {name}. هل تريد استعادته؟", "OpenPDF Editor {name}-এর জন্য স্বয়ংক্রিয়ভাবে সংরক্ষিত কাজ খুঁজে পেয়েছে। এটি পুনরুদ্ধার করবেন?", "O OpenPDF Editor encontrou trabalho não guardado automaticamente para {name}. Pretende recuperá-lo?", "OpenPDF Editor menemukan pekerjaan yang disimpan otomatis untuk {name}. Pulihkan?", "OpenPDF Editor کو {name} کے لیے خودکار طور پر محفوظ کیا گیا کام ملا ہے۔ کیا اسے بحال کریں؟", "OpenPDF Editor našel automaticky uloženou neuloženou práci pro dokument {name}. Chcete ji obnovit?", "OpenPDF Editor našiel automaticky uloženú neuloženú prácu pre dokument {name}. Chcete ju obnoviť?", "OpenPDF Editor znalazł automatycznie zapisaną pracę dla dokumentu {name}. Czy ją odzyskać?"),
...
_ROWS.update({
    ...
    "ocr_unavailable": ("The bundled offline OCR language data is unavailable. Reinstall the complete OpenPDF Editor package.", "捆绑的离线 OCR 语言数据不可用。请重新安装完整的 OpenPDF Editor 软件包。", "बंडल किया गया ऑफ़लाइन OCR भाषा डेटा उपलब्ध नहीं है। पूरा OpenPDF Editor पैकेज फिर से इंस्टॉल करें।", "Los datos de idioma OCR sin conexión incluidos no están disponibles. Vuelva a instalar el paquete completo de OpenPDF Editor.", "Les données linguistiques OCR hors ligne incluses ne sont pas disponibles. Réinstallez le paquet complet OpenPDF Editor.", "بيانات لغة OCR غير المتصلة المضمّنة غير متاحة. أعد تثبيت حزمة OpenPDF Editor الكاملة.", "বান্ডেল করা অফলাইন OCR ভাষার ডেটা পাওয়া যাচ্ছে না। সম্পূর্ণ OpenPDF Editor প্যাকেজ পুনরায় ইনস্টল করুন।", "Os dados de idioma OCR offline incluídos não estão disponíveis. Reinstale o pacote completo do OpenPDF Editor.", "Data bahasa OCR offline yang disertakan tidak tersedia. Instal ulang paket OpenPDF Editor lengkap.", "شامل کردہ آف لائن OCR زبان کا ڈیٹا دستیاب نہیں۔ مکمل OpenPDF Editor پیکیج دوبارہ نصب کریں۔", "Přibalená offline jazyková data OCR nejsou dostupná. Znovu nainstalujte kompletní balíček OpenPDF Editor.", "Pribalené offline jazykové dáta OCR nie sú dostupné. Znova nainštalujte kompletný balík OpenPDF Editor.", "Dołączone dane językowe OCR offline są niedostępne. Zainstaluj ponownie cały pakiet OpenPDF Editor."),
...
_REGIONAL = {
    ...
    "cs": {
        ...
        "about_title": "O aplikaci OpenPDF Editor",
    ...
    "sk": {
        ...
        "about_title": "O aplikácii OpenPDF Editor",
    ...
    "pl": {
        ...
        "about_title": "O aplikacji OpenPDF Editor",
