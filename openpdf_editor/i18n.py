...
BASE = {
    ...
    "redact_area": "Permanently redact area...",
    "redaction_draw_hint": "Drag a rectangle over the sensitive content. Press Esc to cancel.",
    "redaction_title": "Permanent redaction",
    "redaction_confirm": "Permanently remove all page content in this area and cover it in black? This affects text, images, graphics, links, comments, and form fields in the selected area. Other occurrences, metadata, and attachments are not removed. You can use Undo before saving.",
    "redaction_cancelled": "Redaction cancelled.",
    "redaction_complete": "Area permanently redacted. Use Undo to restore it before saving.",
    "edit_text": "Edit text",
    "zoom_in": "Zoom in",
    "zoom_out": "Zoom out",
    "fit_width": "Fit width",
    ...
    "form_field_label": "Tooltip / label:",
    "form_default_value": "Default value:",
    "form_choices": "Choices:",
    "form_choices_hint": "Enter one value per line.",
    "form_default_checked": "Checked by default",
    "form_multiline": "Multiline text",
    "form_required": "Required field",
    "form_shared_name_hint": "Fields with the same name share their value. Use a unique name unless this is intentional.",
    "form_name_required": "Enter a field name.",
    "form_choices_required": "Enter at least two choices, one per line.",
    "form_draw_hint": "Drag a rectangle where the form field should be placed. Press Esc to cancel.",
    "form_created": "Form field created. Use Undo to remove it.",
    "delete_form_field_question": "Delete the selected form field?",
    "form_deleted": "Form field deleted. Use Undo to restore it.",
    ...
    "form_edit_mode": "Edit",
    "form_preview_mode": "Preview",
    "reset_test_data": "Reset test data",
    "fill_form_hint": "Fill fields directly on the page. Changes are saved in the PDF and support Undo/Redo.",
    "clear_form": "Clear form",
    "form_signed": "Signed",
    "form_unsigned": "Unsigned",
    "form_signature_button": "Add visual signature",
    "form_visual_signature_added": "Visual signature added",
    "form_preview_reset": "Test data reset. The PDF was not changed.",
    "form_preview_value_changed": "Test value changed. The PDF was not changed.",
    "form_value_saved": "Form value updated. Use Undo to restore it.",
    "clear_form_question": "Clear all editable form values? This can be undone before saving.",
    "form_values_cleared": "Form values cleared. Use Undo to restore them.",
    "signature_preview_only": "Signature field tested. Preview mode does not change the PDF.",
    "visual_signature_title": "Visual signature",
    "visual_signature_not_digital": "The visual signature was placed in the signature field area. It is not a certificate-based digital signature and the native signature field remains unsigned.",
    "form_value": "Value:",
...
_ROWS.update({
    "create_form_field": ("Create form field...", "创建表单字段...", "फ़ॉर्म फ़ील्ड बनाएँ...", "Crear campo de formulario...", "Créer un champ de formulaire...", "إنشاء حقل نموذج...", "ফর্ম ক্ষেত্র তৈরি করুন...", "Criar campo de formulário...", "Buat bidang formulir...", "فارم فیلڈ بنائیں...", "Vytvořit pole formuláře...", "Vytvoriť pole formulára...", "Utwórz pole formularza..."),
    "delete_form_field": ("Delete selected form field", "删除所选表单字段", "चुना हुआ फ़ॉर्म फ़ील्ड हटाएँ", "Eliminar campo de formulario seleccionado", "Supprimer le champ de formulaire sélectionné", "حذف حقل النموذج المحدد", "নির্বাচিত ফর্ম ক্ষেত্র মুছুন", "Eliminar campo de formulário selecionado", "Hapus bidang formulir terpilih", "منتخب فارم فیلڈ حذف کریں", "Odstranit vybrané pole formuláře", "Odstrániť vybrané pole formulára", "Usuń wybrane pole formularza"),
    "form_type_text": ("Text field", "文本字段", "टेक्स्ट फ़ील्ड", "Campo de texto", "Champ de texte", "حقل نص", "টেক্সট ক্ষেত্র", "Campo de texto", "Bidang teks", "متن فیلڈ", "Textové pole", "Textové pole", "Pole tekstowe"),
    "form_type_checkbox": ("Check box", "复选框", "चेक बॉक्स", "Casilla", "Case à cocher", "مربع اختيار", "চেক বক্স", "Caixa de seleção", "Kotak centang", "چیک باکس", "Zaškrtávací pole", "Začiarkavacie pole", "Pole wyboru"),
    "form_type_combo": ("Drop-down list", "下拉列表", "ड्रॉप-डाउन सूची", "Lista desplegable", "Liste déroulante", "قائمة منسدلة", "ড্রপ-ডাউন তালিকা", "Lista pendente", "Daftar tarik-turun", "ڈراپ ڈاؤن فہرست", "Rozbalovací seznam", "Rozbaľovací zoznam", "Lista rozwijana"),
    "form_type_list": ("List box", "列表框", "सूची बॉक्स", "Cuadro de lista", "Zone de liste", "مربع قائمة", "তালিকা বাক্স", "Caixa de lista", "Kotak daftar", "فہرست خانہ", "Seznam", "Zoznam", "Pole listy"),
    "form_field_type": ("Field type:", "字段类型：", "फ़ील्ड प्रकार:", "Tipo de campo:", "Type de champ :", "نوع الحقل:", "ক্ষেত্রের ধরন:", "Tipo de campo:", "Jenis bidang:", "فیلڈ کی قسم:", "Typ pole:", "Typ poľa:", "Typ pola:"),
    "form_field_name": ("Field name:", "字段名称：", "फ़ील्ड नाम:", "Nombre del campo:", "Nom du champ :", "اسم الحقل:", "ক্ষেত্রের নাম:", "Nome do campo:", "Nama bidang:", "فیلڈ کا نام:", "Název pole:", "Názov poľa:", "Nazwa pola:"),
    "form_field_label": ("Tooltip / label:", "工具提示/标签：", "टूलटिप / लेबल:", "Ayuda / etiqueta:", "Info-bulle / libellé :", "تلميح / تسمية:", "টুলটিপ / লেবেল:", "Dica / etiqueta:", "Tip alat / label:", "ٹول ٹپ / لیبل:", "Nápověda / popisek:", "Pomocník / popis:", "Podpowiedź / etykieta:"),
    "form_default_value": ("Default value:", "默认值：", "डिफ़ॉल्ट मान:", "Valor predeterminado:", "Valeur par défaut :", "القيمة الافتراضية:", "ডিফল্ট মান:", "Valor predefinido:", "Nilai bawaan:", "طے شدہ قدر:", "Výchozí hodnota:", "Predvolená hodnota:", "Wartość domyślna:"),
    "form_choices": ("Choices:", "选项：", "विकल्प:", "Opciones:", "Choix :", "الخيارات:", "পছন্দসমূহ:", "Opções:", "Pilihan:", "اختیارات:", "Možnosti:", "Možnosti:", "Opcje:"),
    "form_choices_hint": ("Enter one value per line.", "每行输入一个值。", "प्रति पंक्ति एक मान दर्ज करें।", "Introduzca un valor por línea.", "Saisissez une valeur par ligne.", "أدخل قيمة واحدة في كل سطر.", "প্রতি লাইনে একটি মান লিখুন।", "Introduza um valor por linha.", "Masukkan satu nilai per baris.", "ہر سطر میں ایک قدر درج کریں۔", "Zadejte jednu hodnotu na řádek.", "Zadajte jednu hodnotu na riadok.", "Wprowadź jedną wartość w wierszu."),
    "form_default_checked": ("Checked by default", "默认选中", "डिफ़ॉल्ट रूप से चयनित", "Marcada de forma predeterminada", "Cochée par défaut", "محدد افتراضيًا", "ডিফল্টভাবে নির্বাচিত", "Selecionada por predefinição", "Dicentang secara bawaan", "بطور ڈیفالٹ منتخب", "Ve výchozím stavu zaškrtnuto", "Predvolene začiarknuté", "Domyślnie zaznaczone"),
    "form_multiline": ("Multiline text", "多行文本", "बहु-पंक्ति पाठ", "Texto de varias líneas", "Texte multiligne", "نص متعدد الأسطر", "বহু-লাইনের লেখা", "Texto multilinha", "Teks multibaris", "کثیر سطری متن", "Víceřádkový text", "Viacriadkový text", "Tekst wielowierszowy"),
    "form_shared_name_hint": ("Fields with the same name share their value. Use a unique name unless this is intentional.", "同名字段共享其值。除非有意如此，否则请使用唯一名称。", "समान नाम वाले फ़ील्ड एक ही मान साझा करते हैं। जानबूझकर न हो तो अलग नाम रखें।", "Los campos con el mismo nombre comparten su valor. Use un nombre único salvo que sea intencional.", "Les champs de même nom partagent leur valeur. Utilisez un nom unique sauf si cela est voulu.", "الحقول ذات الاسم نفسه تشترك في القيمة. استخدم اسمًا فريدًا إلا إذا كان ذلك مقصودًا.", "একই নামের ক্ষেত্র একই মান ভাগ করে। ইচ্ছাকৃত না হলে অনন্য নাম ব্যবহার করুন।", "Campos com o mesmo nome partilham o valor. Use um nome único, salvo se for intencional.", "Bidang dengan nama yang sama berbagi nilai. Gunakan nama unik kecuali disengaja.", "ایک ہی نام والے فیلڈ قدر مشترک رکھتے ہیں۔ اگر ارادی نہ ہو تو منفرد نام استعمال کریں۔", "Pole se stejným názvem sdílejí hodnotu. Pokud to není záměr, použijte jedinečný název.", "Polia s rovnakým názvom zdieľajú hodnotu. Ak to nie je zámer, použite jedinečný názov.", "Pola o tej samej nazwie współdzielą wartość. Użyj unikalnej nazwy, jeśli nie jest to zamierzone."),
    "form_name_required": ("Enter a field name.", "请输入字段名称。", "फ़ील्ड नाम दर्ज करें।", "Introduzca un nombre de campo.", "Saisissez un nom de champ.", "أدخل اسم الحقل.", "ক্ষেত্রের নাম লিখুন।", "Introduza um nome de campo.", "Masukkan nama bidang.", "فیلڈ کا نام درج کریں۔", "Zadejte název pole.", "Zadajte názov poľa.", "Wprowadź nazwę pola."),
    "form_choices_required": ("Enter at least two choices, one per line.", "请至少输入两个选项，每行一个。", "कम से कम दो विकल्प, प्रति पंक्ति एक, दर्ज करें।", "Introduzca al menos dos opciones, una por línea.", "Saisissez au moins deux choix, un par ligne.", "أدخل خيارين على الأقل، واحدًا في كل سطر.", "অন্তত দুটি পছন্দ লিখুন, প্রতি লাইনে একটি।", "Introduza pelo menos duas opções, uma por linha.", "Masukkan setidaknya dua pilihan, satu per baris.", "کم از کم دو اختیارات، ہر سطر میں ایک، درج کریں۔", "Zadejte alespoň dvě možnosti, každou na samostatný řádek.", "Zadajte aspoň dve možnosti, každú na samostatný riadok.", "Wprowadź co najmniej dwie opcje, każdą w osobnym wierszu."),
    "form_draw_hint": ("Drag a rectangle where the form field should be placed. Press Esc to cancel.", "在要放置表单字段的位置拖出矩形。按 Esc 取消。", "जहाँ फ़ॉर्म फ़ील्ड रखना है वहाँ आयत खींचें। रद्द करने के लिए Esc दबाएँ।", "Arrastre un rectángulo donde se colocará el campo. Pulse Esc para cancelar.", "Tracez un rectangle à l’emplacement du champ. Appuyez sur Échap pour annuler.", "اسحب مستطيلاً حيث تريد وضع حقل النموذج. اضغط Esc للإلغاء.", "ফর্ম ক্ষেত্রের স্থানে একটি আয়তক্ষেত্র টানুন। বাতিল করতে Esc চাপুন।", "Arraste um retângulo onde o campo será colocado. Prima Esc para cancelar.", "Seret kotak di lokasi bidang formulir. Tekan Esc untuk batal.", "جہاں فارم فیلڈ رکھنا ہے وہاں مستطیل کھینچیں۔ منسوخ کرنے کے لیے Esc دبائیں۔", "Tažením vyznačte místo pro pole formuláře. Klávesou Esc akci zrušíte.", "Ťahaním vyznačte miesto pre pole formulára. Klávesom Esc akciu zrušíte.", "Przeciągnij prostokąt w miejscu pola formularza. Naciśnij Esc, aby anulować."),
    "form_created": ("Form field created. Use Undo to remove it.", "表单字段已创建。使用撤销可将其删除。", "फ़ॉर्म फ़ील्ड बनाया गया। हटाने के लिए पूर्ववत करें।", "Campo creado. Use Deshacer para eliminarlo.", "Champ créé. Utilisez Annuler pour le supprimer.", "تم إنشاء حقل النموذج. استخدم تراجع لإزالته.", "ফর্ম ক্ষেত্র তৈরি হয়েছে। সরাতে পূর্বাবস্থায় ফেরান।", "Campo criado. Use Anular para o remover.", "Bidang formulir dibuat. Gunakan Urungkan untuk menghapusnya.", "فارم فیلڈ بن گیا۔ ہٹانے کے لیے کالعدم کریں۔", "Pole formuláře bylo vytvořeno. Pomocí Zpět je odstraníte.", "Pole formulára bolo vytvorené. Pomocou Späť ho odstránite.", "Pole formularza utworzono. Użyj Cofnij, aby je usunąć."),
    "delete_form_field_question": ("Delete the selected form field?", "删除所选表单字段？", "चुना हुआ फ़ॉर्म फ़ील्ड हटाएँ?", "¿Eliminar el campo seleccionado?", "Supprimer le champ sélectionné ?", "هل تريد حذف حقل النموذج المحدد؟", "নির্বাচিত ফর্ম ক্ষেত্র মুছবেন?", "Eliminar o campo selecionado?", "Hapus bidang formulir terpilih?", "منتخب فارم فیلڈ حذف کریں؟", "Odstranit vybrané pole formuláře?", "Odstrániť vybrané pole formulára?", "Usunąć wybrane pole formularza?"),
    "form_deleted": ("Form field deleted. Use Undo to restore it.", "表单字段已删除。使用撤销可恢复。", "फ़ॉर्म फ़ील्ड हटाया गया। पुनर्स्थापित करने के लिए पूर्ववत करें।", "Campo eliminado. Use Deshacer para restaurarlo.", "Champ supprimé. Utilisez Annuler pour le restaurer.", "تم حذف حقل النموذج. استخدم تراجع لاستعادته.", "ফর্ম ক্ষেত্র মুছে গেছে। ফেরাতে পূর্বাবস্থায় ফেরান।", "Campo eliminado. Use Anular para o restaurar.", "Bidang formulir dihapus. Gunakan Urungkan untuk memulihkannya.", "فارم فیلڈ حذف ہو گیا۔ بحال کرنے کے لیے کالعدم کریں۔", "Pole formuláře bylo odstraněno. Pomocí Zpět je obnovíte.", "Pole formulára bolo odstránené. Pomocou Späť ho obnovíte.", "Pole formularza usunięto. Użyj Cofnij, aby je przywrócić."),
})
...
_REGIONAL = {
    ...
    "cs": {
        "fill_and_sign": "Vyplnit a podepsat",
        "form_type_signature": "Podpisové pole",
        "form_required": "Povinné pole",
        "form_edit_mode": "Upravit",
        "form_preview_mode": "Vyzkoušet",
        "reset_test_data": "Vymazat testovací data",
        "fill_form_hint": "Vyplňujte pole přímo na stránce. Změny se zapisují do PDF a podporují Zpět/Znovu.",
        "clear_form": "Vymazat formulář",
        "form_signed": "Podepsáno",
        "form_unsigned": "Nepodepsáno",
        "form_signature_button": "Přidat vizuální podpis",
        "form_visual_signature_added": "Vizuální podpis přidán",
        "form_preview_reset": "Testovací data byla vymazána. PDF se nezměnilo.",
        "form_preview_value_changed": "Testovací hodnota byla změněna. PDF se nezměnilo.",
        "form_value_saved": "Hodnota formuláře byla změněna. Obnovit ji můžete pomocí Zpět.",
        "clear_form_question": "Vymazat všechny upravitelné hodnoty formuláře? Před uložením lze použít Zpět.",
        "form_values_cleared": "Hodnoty formuláře byly vymazány. Obnovit je můžete pomocí Zpět.",
        "signature_preview_only": "Podpisové pole bylo vyzkoušeno. Režim náhledu PDF nemění.",
        "visual_signature_title": "Vizuální podpis",
        "visual_signature_not_digital": "Vizuální podpis byl vložen do oblasti podpisového pole. Nejde o digitální podpis založený na certifikátu a nativní podpisové pole zůstává nepodepsané.",
...
_ROWS.update({
    ...
    "redaction_confirm": ("Permanently remove all page content in this area and cover it in black? This affects text, images, graphics, links, comments, and form fields in the selected area. Other occurrences, metadata, and attachments are not removed. You can use Undo before saving.", "永久删除此区域中的所有页面内容并以黑色覆盖？这会影响所选区域内的文本、图像、图形、链接、注释和表单字段。其他位置、元数据和附件不会被删除。保存前可使用撤销。", "इस क्षेत्र की सभी पृष्ठ सामग्री स्थायी रूप से हटाकर काले रंग से ढकें? चयनित क्षेत्र के पाठ, चित्र, ग्राफ़िक्स, लिंक, टिप्पणियाँ और फ़ॉर्म फ़ील्ड प्रभावित होंगे। अन्य स्थान, मेटाडेटा और संलग्नक नहीं हटेंगे। सहेजने से पहले पूर्ववत किया जा सकता है।", "¿Eliminar permanentemente todo el contenido de esta área y cubrirla de negro? Afecta al texto, imágenes, gráficos, enlaces, comentarios y campos del área seleccionada. No elimina otras apariciones, metadatos ni adjuntos. Puede deshacer antes de guardar.", "Supprimer définitivement tout le contenu de cette zone et la recouvrir de noir ? Le texte, les images, les graphiques, les liens, les commentaires et les champs sélectionnés seront concernés. Les autres occurrences, métadonnées et pièces jointes ne seront pas supprimées. Vous pouvez annuler avant l’enregistrement.", "هل تريد إزالة كل محتوى الصفحة في هذه المنطقة نهائيًا وتغطيته بالأسود؟ سيؤثر ذلك في النصوص والصور والرسومات والروابط والتعليقات وحقول النماذج داخل المنطقة المحددة. لن تُحذف المواضع الأخرى أو البيانات الوصفية أو المرفقات. يمكنك التراجع قبل الحفظ.", "এই এলাকার সব পৃষ্ঠা বিষয়বস্তু স্থায়ীভাবে মুছে কালো দিয়ে ঢাকবেন? নির্বাচিত এলাকার লেখা, ছবি, গ্রাফিক্স, লিংক, মন্তব্য ও ফর্ম ক্ষেত্র প্রভাবিত হবে। অন্য উপস্থিতি, মেটাডেটা ও সংযুক্তি মুছবে না। সংরক্ষণের আগে পূর্বাবস্থায় ফেরাতে পারেন।", "Remover permanentemente todo o conteúdo desta área e cobri-la de preto? Afeta texto, imagens, gráficos, ligações, comentários e campos na área selecionada. Outras ocorrências, metadados e anexos não são removidos. Pode anular antes de guardar.", "Hapus permanen semua konten halaman di area ini dan tutup dengan warna hitam? Teks, gambar, grafis, tautan, komentar, dan bidang formulir di area terpilih akan terpengaruh. Kemunculan lain, metadata, dan lampiran tidak dihapus. Anda dapat membatalkan sebelum menyimpan.", "اس علاقے کا تمام صفحاتی مواد مستقل طور پر ہٹا کر سیاہ کر دیں؟ منتخب علاقے میں متن، تصاویر، گرافکس، روابط، تبصرے اور فارم فیلڈ متاثر ہوں گے۔ دیگر مقامات، میٹا ڈیٹا اور منسلکات حذف نہیں ہوں گے۔ محفوظ کرنے سے پہلے کالعدم کیا جا سکتا ہے۔", "Trvale odstranit veškerý obsah stránky v této oblasti a překrýt jej černou barvou? Zmizí text, obrázky, grafika, odkazy, komentáře a formulářová pole ve výběru. Další výskyty, metadata ani přílohy odstraněny nebudou. Před uložením lze použít Zpět.", "Trvalo odstrániť všetok obsah strany v tejto oblasti a prekryť ho čiernou farbou? Zmizne text, obrázky, grafika, odkazy, komentáre a formulárové polia vo výbere. Ďalšie výskyty, metadáta ani prílohy odstránené nebudú. Pred uložením možno použiť Späť.", "Trwale usunąć całą zawartość strony w tym obszarze i zakryć ją czernią? Dotyczy to tekstu, obrazów, grafiki, łączy, komentarzy i pól formularza w zaznaczeniu. Inne wystąpienia, metadane i załączniki nie zostaną usunięte. Przed zapisaniem można użyć Cofnij."),
    "redaction_cancelled": ("Redaction cancelled.", "已取消遮盖。", "संशोधन रद्द किया गया।", "Censura cancelada.", "Masquage annulé.", "تم إلغاء الحجب.", "গোপনকরণ বাতিল হয়েছে।", "Ocultação cancelada.", "Redaksi dibatalkan.", "حذف منسوخ کر دیا گیا۔", "Začernění bylo zrušeno.", "Začiernenie bolo zrušené.", "Redakcja anulowana."),
    "redaction_complete": ("Area permanently redacted. Use Undo to restore it before saving.", "区域已永久遮盖。保存前可使用撤销恢复。", "क्षेत्र स्थायी रूप से संशोधित किया गया। सहेजने से पहले पूर्ववत करके पुनर्स्थापित करें।", "Área censurada permanentemente. Use Deshacer para restaurarla antes de guardar.", "Zone définitivement masquée. Utilisez Annuler pour la restaurer avant l’enregistrement.", "تم حجب المنطقة نهائيًا. استخدم التراجع لاستعادتها قبل الحفظ.", "এলাকা স্থায়ীভাবে গোপন করা হয়েছে। সংরক্ষণের আগে পূর্বাবস্থায় ফিরিয়ে পুনরুদ্ধার করুন।", "Área ocultada permanentemente. Use Anular para a restaurar antes de guardar.", "Area telah disunting permanen. Gunakan Urungkan untuk memulihkannya sebelum menyimpan.", "علاقہ مستقل طور پر حذف کر دیا گیا۔ محفوظ کرنے سے پہلے کالعدم کر کے بحال کریں۔", "Oblast byla trvale začerněna. Před uložením ji lze obnovit pomocí Zpět.", "Oblasť bola trvalo začiernená. Pred uložením ju možno obnoviť pomocou Späť.", "Obszar trwale zredagowano. Przed zapisaniem można go przywrócić poleceniem Cofnij."),
})
